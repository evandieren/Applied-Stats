...
anova(glsfit,sig_glsfit) # other way around
```

From this test, we observe the non-significance of the exponential part of the modeling, and the significance of the linear and quadratic dependance on time. This helps us answering the question regarding the exponential growth of the temperature around the globe : *it is not significant*, one could see that a low quadratic function might work better to fit the model. 
