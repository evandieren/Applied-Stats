...
The method presented here consists of fitting the trend with a Generalized Additive model and then find SARIMA parameters for its residuals. This section is considered additional and only gives the reader another way to forecast temperature anomalies, without assessing the two questions. The methods really ressemble the one previously presented and lots of analyses are analogous to previous ones, hence the short description of certain results in this section.
