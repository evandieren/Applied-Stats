...
summary(gm0)
```
The above test tells us what happens when we are dropping a single predictor from a saturated model. Here we observe that traffic_type, the month, exit_rates, time_product_page and page_values are statistically significant.
